// =========================================================================
// MAP DATA, TERRAIN PARSING & UNIT SPAWNING CONTROLLER (24x34 GRID SYSTEM)
// =========================================================================
...
const artList = ["BG23", "BR25", "BQ33", "BL42"];
const tList = ["BG24", "BP27", "BR33", "BK42"];
const rbList = ["BK43", "BL43", "BM43", "BK44", "BM44", "BK45", "BL45", "BM45"];
const bbList = ["BF23", "BF24", "BD25", "BE25", "BF25"];
const navList = ["BG22", "BN24", "BD32", "BS34"];
...
function spawnTeam(team) {
    ...
    let spawnCoordStr = isBlue ? bbcList[0] : rbcList[0];
    let startPos = parseCoord(spawnCoordStr);

    let infantryImgRef = isBlue ? window.blueInfantryImg : window.redInfantryImg;
    let infantryLoadRef = () => isBlue ? window.blueInfantryLoaded : window.redInfantryLoaded;

    // Define 2 distinct surrounding offset coordinates for two infantry units
    let offsets = [
        { c: -1, r: 0 },
        { c: 1, r: 0 }
    ];
    ...
    offsets.forEach(offset => {
        let pc = startPos.c + offset.c;
        let pr = startPos.r + offset.r;
        window.units.push({ 
            name: 'Infantry', 
            type: 'land', 
            range: 2, 
